...
<div class="container insomniac-project project-page">
	<div class="page-header">
		<img src="img/work/insomniac/project-header.jpg">
	</div>
	<div class="wrapper">
	<div class="project-header">
		<div class="project-header-title">
			<h2>Insomniac.com - Mood Boards</h2>
			<p>Role: Graphic Design<br/>
			Agency: The Firm Graphics</p>
		</div>
		<div class="project-intro">
			<p class="toggle-view">Insomniac produces some of the most innovative, immersive music festivals and events in the world. The quality of the experience is the company’s top priority.</p>
		</div> 
	</div>
	</div>
